-- Full ZIP3 prefix → state_code seed for zip_prefix_state_lookup.
-- Covers all assigned US ZIP3 prefixes (000–999).
-- Unassigned ranges are omitted. Military/territories included where relevant.

insert into public.zip_prefix_state_lookup (zip_prefix, state_code)
values
  ...
  -- MARYLAND (MD) 206-219 (200-205 are DC)
  ...
  -- 569 (also used by DC APO/FPO, map to DC for pricing purposes)
  ...
  ('335','FL'),('336','FL'),('337','FL'),('338','FL'),
  ('339','FL'),
  ('340','FL'),-- military/overseas
  ('341','FL'),('342','FL'),('344','FL'),('346','FL'),('347','FL'),
  ('349','FL'),

  -- ALABAMA (AL) 350-369
  ('350','AL'),('351','AL'),('352','AL'),
  ('354','AL'),('355','AL'),('356','AL'),('357','AL'),('358','AL'),
  ('359','AL'),('360','AL'),('361','AL'),('362','AL'),('363','AL'),
  ('364','AL'),('365','AL'),('366','AL'),('367','AL'),('368','AL'),
  ('369','AL'),

  -- TENNESSEE (TN) 370-385
  ('370','TN'),('371','TN'),('372','TN'),('373','TN'),('374','TN'),
  ('376','TN'),('377','TN'),('378','TN'),('379','TN'),
  ...
  ('550','MN'),('551','MN'),
  ('553','MN'),('554','MN'),('555','MN'),('556','MN'),('557','MN'),
  ('558','MN'),('559','MN'),
  ...
  -- OKLAHOMA (OK) 730-749
  ('730','OK'),('731','OK'),
  ('734','OK'),('735','OK'),('736','OK'),('737','OK'),('738','OK'),
  ('739','OK'),
